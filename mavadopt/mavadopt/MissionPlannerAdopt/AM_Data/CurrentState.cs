    ...
    public class CurrentState : ICloneable
    {
        ...
        public float ch3percent
        {
            get
            {
                ...
                try
                {
                    if (Form1.comPort.MAV.param.ContainsKey("RC3_MIN") && Form1.comPort.MAV.param.ContainsKey("RC3_MAX"))
                    {
                        return (int)(((ch3out - (float)Form1.comPort.MAV.param["RC3_MIN"]) / ((float)Form1.comPort.MAV.param["RC3_MAX"] - (float)Form1.comPort.MAV.param["RC3_MIN"])) * 100);
                    }
                    else
                    {
                        if (ch3out == 0)
     ...
     [DisplayText("Elevation to Mav (deg)")]
        ...
        public bool connected { get { return (Form1.comPort.BaseStream.IsOpen || Form1.comPort.logreadmode); } }
        ...
        public string GetNameandUnit(string name)
        {
            ...
            try
            {
                ...
                if (typeofthing != null)
                {
                    ...
                    if (attrib.Length > 0)
                        desc = ((DisplayTextAttribute)attrib[0]).Text;
                }
            }
            catch { }
        ...
        {
            UpdateCurrentSettings(bs, false, Form1.comPort, Form1.comPort.MAV);
        }
